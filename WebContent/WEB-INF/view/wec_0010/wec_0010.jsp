            ...
            <div class="col-md-12">
                <form class="form-horizontal" id="user-reg">
                    <div class="input-group">
                        ...
                        <input type="text" id="mobile" class="form-control" value="18678399534" placeholder="手机号不可为空" aria-describedby="basic-addon1">
                    </div>
                    <div class="input-group">
                        <div class="input-group">
                    ...
                    <div class="input-group">
                        ...
                        <select id="kaleixing" class="form-control" aria-describedby="basic-addon1">
                            <option value="">请选择</option>
                            <option value="1">申请新卡</option>
                            <option value="2">绑定旧卡</option>
                        </select>
                    </div>
                    ...
                    <div id="new_card" class="input-group">
                        <div class="panel panel-info">
                            <div class="panel-heading">
                                <h3 class="panel-title">申请新卡界面</h3>
                            </div>
                            <div class="panel-body">
                                <h4>请输入6位开卡密码</h4>
                                <div class="input-group">
                                    <span class="input-group-addon" for="new_card_psd1">密码：</span>
                                    <input type="text" id="new_card_psd1" class="form-control" aria-describedby="basic-addon1">
                                </div>
                                <div class="input-group">
                                    <span class="input-group-addon" for="new_card_psd2">确认密码：</span>
                    ...
                    <div id="old_card" class="input-group">
                        <div class="panel panel-info">
                            <div class="panel-heading">
                                <h3 class="panel-title">绑定旧卡界面</h3>
                            </div>
                            <div class="panel-body">
                                <div class="input-group">
                                    <span class="input-group-addon" for="new_card_psd1">卡号：</span>
                                    <input type="text" id="old_card_code" class="form-control" aria-describedby="basic-addon1">
                                </div>
                                <div class="input-group">
                                    <span class="input-group-addon" for="new_card_psd2">密码：</span>
                                    <input type="text" id="old_card_psd" class="form-control" aria-describedby="basic-addon1">
                                </div>
                            </div>
                        </div>
                    </div>
