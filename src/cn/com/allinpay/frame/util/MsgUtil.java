...
public class MsgUtil {
	...
	public static void main(String[] strArr) {
		...
		_smsManager.demoClient("13964174920", "hello 十大歌手沈大高速公路123456");
	}

	public void demoClient(String strSendphone, String strContents) {
		String urlPath = WechatCardCommonUtil.getSendVerifyUrl();
		...
		try {
			...
			uc.setRequestProperty("Content-Type", "text/html;charset=UTF-8");// AS//uc.setRequestProperty("Content-Type","text/xml;charset=UTF-8");
